...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlaylist
	{
		...
		public class MediaItem
		{
			...
			[SerializeField] public TransparencyMode TransParencyMode = TransparencyMode.Opaque;
		}
		...
		public void OpenVideoFile(MediaPlaylist.MediaItem mediaItem)
 		{
			...
			else
			{
				...
				{
					NextPlayer.OpenMedia(NextPlayer.MediaPath.PathType, NextPlayer.MediaPath.Path, _nextItem.startMode == StartMode.Immediate, _nextItem.TransParencyMode);
				}
			}
		}
